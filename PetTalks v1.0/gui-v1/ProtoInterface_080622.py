...
class Aplicacion:
    def __init__(self, root):
        ...
        #######################################
##############################################################
        self.finalButon = tkinter.Button(root, text="Go!", command=self.returnDeTodo,height=2, width=19).place(x=wWeight*0.05, y=wHeight * 0.86)

        self.finalButon = tkinter.Button(root, text="Save", command=self.returnDeTodo, height=2, width=19).place(x=wWeight * 0.242, y=wHeight * 0.86)
